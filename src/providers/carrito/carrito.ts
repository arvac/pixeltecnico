...
export class CarritoProvider {
             ...
             .subscribe( resp =>{
               ...
               if( respuesta.error ){
                ...
                this.alertCtrl.create({
                  ...
                  subTitle: "tomaremos su correo para contactarnos con usted",
                  buttons: ["OK"]
                }).present();
               }
  ...
  cargar_ordenes(){
    ...
    let url = `${ URL_SERVICIOS }/pedidos/obtpedidos/${ this._us.token }/${ this._us.id_usuario }`;
  ...
  borrar_orden( orden_id:string ){
    ...
    let url = `${ URL_SERVICIOS }/pedidos/borrarperdido/${ this._us.token }/${ this._us.id_usuario }/${ orden_id }`;
